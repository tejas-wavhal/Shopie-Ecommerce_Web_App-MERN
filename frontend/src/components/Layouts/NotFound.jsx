...
const NotFound = () => {
  return (
    <>
      <MetaData title={"Shopie - Not Found"} />
      <section className="flex items-center h-[80vh] p-16 text-gray-900">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
          <div className="max-w-md text-center">
            ...
            <Link to='/'>
              <button className="flex items-center mt-auto text-white bg-orange-500 border-0 py-2 px-4 w-48 mx-auto focus:outline-none hover:bg-orange-600 rounded">Home
