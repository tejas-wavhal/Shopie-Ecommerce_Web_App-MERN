  ...
  return (
    <div className='mx-4'>
      ...
      <form className="mx-auto lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full my-20" onSubmit={submitHandler}>
        ...
        <p className="text-lg text-gray-500 mt-3">New user? <Link to={'/register'}><b className='text-orange-500 cursor-pointer'>Sign Up</b></Link> Here</p>
      </form>
    </div>
  )
}
