      ...
      <div className='lg:min-h-[80vh] flex flex-col-reverse lg:flex-row'>
        <div className='mx-auto mb-10 min-h-[60vh] w-full'>
          ...
          <div className='mx-auto my-10 w-[80%]'>
            <form className="mx-auto lg:w-3/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col my-20" onSubmit={createProductSubmitHandler}>
              <h1 className="text-gray-900 text-lg font-medium title-font mb-5">Create Product</h1>
              ...
              <div className="relative mb-4">
                ...
                <input required accept='image/*' multiple className="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" onChange={createProductImagesChange} />
              </div>
